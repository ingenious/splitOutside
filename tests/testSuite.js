        ...
        describe(testType + ' Functional tests', function() {
            ...
            describe('splitOutside method', function() {
                ...
                it('should interpret an array [test,part] between delimiters', function(done) {
                    ...
                    assert.strictEqual((SO ? SO.splitOutside("[3,4,5],[test, part],unseen hole", ',', {}) : "[3,4,5],[test, part],unseen hole".splitOutside(',', {}))[0][2], 5);
                    done();

                });
                it('should interpret attributes and methods from a passed context between delimiters', function(done) {
                    assert.strictEqual((SO ? SO.splitOutside("3,4,[test, part],unseen hole", ',', {
                        test: 'world',
                        part: 42
                    ...
                    assert.strictEqual((SO ? SO.splitOutside("[3,4,5],[test, part],unseen hole", ',', {
                        test: 'world',
                        part: 42
                    }) : "[3,4],[test, part],unseen hole".splitOutside(',', {
                        test: 'world',
            ...
            describe('parseExpression method', function() {
                ...
                it('should evaluate attributes and methods of a passed context', function(done) {
                    assert.strictEqual(SO ? SO.parseExpression('a/b()', {
                        a: 14,
                        b: function() {
                            return 7;
                        }
